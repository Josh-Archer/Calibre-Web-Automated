...
CREATE TABLE IF NOT EXISTS cwa_settings(
    ...
    amazon_heartbeat_fail_count INTEGER DEFAULT 0 NOT NULL,
    amazon_heartbeat_last_error TEXT DEFAULT "" NOT NULL,
    amazon_heartbeat_last_success_utc TEXT DEFAULT "" NOT NULL
);
