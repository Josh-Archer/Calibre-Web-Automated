...
class CWA_DB:
    ...
    def kindle_sync_get_all_confirmed_any_user(self):
        """Returns a set of all book_ids that have status='confirmed' for any user."""
        try:
            self.cur.execute("""
            ...
            print(f"[cwa-db] Error getting global confirmed Kindle sync status: {e}")
            return set()
